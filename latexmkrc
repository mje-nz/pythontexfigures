...
# Use make to generate figures
#$use_make_for_missing_files = 1;

# Don't try to build included files
@default_excluded_files = ( 'acronyms.tex' );

# Clean up
push @generated_exts, 'tdo', 'synctex.gz';


# Support for pythontex in v. 0.16 or higher, with latexmk 4.62 or higher
# From http://mirror.aut.ac.nz/CTAN/support/latexmk/example_rcfiles/pythontex-latexmkrc
#
